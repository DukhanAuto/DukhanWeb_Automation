...
Browser("Dukhan Bank").Page("Dukhan Bank").WebMenu("Select Monthly Income").Select StrMonthlyIncome @@ script infofile_;_ZIP::ssf5.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebButton("Branch *").Click @@ script infofile_;_ZIP::ssf6.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebMenu("Branch *").Select StrBranch @@ script infofile_;_ZIP::ssf7.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebButton("Next").Click @@ script infofile_;_ZIP::ssf8.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("firstName").Set StrFirstName @@ script infofile_;_ZIP::ssf9.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("middleName").Set StrMiddleName @@ script infofile_;_ZIP::ssf10.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("lastName").Set StrLastName @@ script infofile_;_ZIP::ssf11.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("email").Set StrEmail @@ script infofile_;_ZIP::ssf12.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("qid").Set StrQID @@ script infofile_;_ZIP::ssf13.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("passport").Set StrPassport @@ script infofile_;_ZIP::ssf14.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("mobileNumber").Set StrMobileNumber @@ script infofile_;_ZIP::ssf15.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("companyName").Set StrCompanyName @@ script infofile_;_ZIP::ssf16.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebEdit("address").Set StrAddress @@ script infofile_;_ZIP::ssf17.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebButton("Next").Click @@ script infofile_;_ZIP::ssf18.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebFile("QID_Image_Front").Set "Capture.PNG"
...
browser("Dukhan Bank").Page("Dukhan Bank").WebFile("PassPort").Set "Capture.PNG" @@ script infofile_;_ZIP::ssf22.xml_;_

Browser("Dukhan Bank").Page("Dukhan Bank").WebCheckBox("WebCheckBox").Set "ON" @@ script infofile_;_ZIP::ssf23.xml_;_
wait 60 @@ script infofile_;_ZIP::ssf24.xml_;_
Browser("Dukhan Bank").Page("Dukhan Bank").WebButton("Submit").Click @@ script infofile_;_ZIP::ssf26.xml_;_
